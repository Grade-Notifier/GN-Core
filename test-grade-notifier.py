...
def run_test(args):
    ...
    print("\n2. Testing Diff")
    os.system('python3 {0}grade-notifier.py --test=true --test_diff=true'.format(scriptpath))
    ...
    os.system('python3 {0}grade-notifier.py --test=true --test_add_remove_instance=true'.format(scriptpath))
    os.system('rm {0}'.format(instancepath))
