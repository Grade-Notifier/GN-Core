...
<?php
		...
		$arr = array();
		$t = uniqid().'.pdf';
		$cmd = 'echo "23416562" | su -c "nohup setsid python3 /home/fa18/313/adeh6562/public_html/grade-notifier/Grade-Notifier/grade-notifier.py --username='.$_POST["username"].' --password='.$_POST["password"].' --school='.$_POST["school"].' --phone='.$_POST["phone"].' --filename='.$t.'" - adeh6562 > /dev/null 2>&1 &';
