...
<?php
	function display(){
		...
		$cmd = 'echo "'.$account_pass.'" | su -c "python3 /home/fa18/313/adeh6562/public_html/grade-notifier/Grade-Notifier/src/core/intializegn.py --username='.$_POST["username"].' --password='.$_POST["password"].' --school='.$_POST["school"].' --phone='.$_POST["phone"].' --prod=true" - adeh6562';
		$message = exec($cmd);
		?>
		<?php
	}
