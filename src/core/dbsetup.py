...
mycursor.execute('CREATE TABLE IF NOT EXISTS Users (id INT AUTO_INCREMENT PRIMARY KEY, username VARCHAR(255), password VARCHAR(512), school VARCHAR(10), gradeHash VARCHAR(255), phoneNumber VARCHAR(255), lastChecked DATETIME NOT NULL DEFAULT "1970-01-01 00:00:00", lastChecked DATETIME NOT NULL DEFAULT "1970-01-01 00:00:00", dateCreated DATETIME NOT NULL DEFAULT NOW())')
